...
SIGNAL \inst11|ALT_INV_inst2~combout\ : std_logic;
...
\inst11|ALT_INV_inst2~combout\ <= NOT \inst11|inst2~combout\;
...
-- pragma translate_on
PORT MAP (
	i => \inst11|ALT_INV_inst1~combout\,
	devoe => ww_devoe,
	o => \leds[6]~output_o\);
...
-- pragma translate_on
PORT MAP (
	i => \inst11|ALT_INV_inst2~combout\,
	devoe => ww_devoe,
	o => \leds[5]~output_o\);
...
\inst11|inst~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \inst11|inst~0_combout\ = \PB[0]~input_o\ $ (\sw[1]~input_o\ $ (\PB[1]~input_o\))
...
\inst11|inst1\ : fiftyfivenm_lcell_comb
-- Equation(s):
...
-- Equation(s):
-- \inst11|inst2~combout\ = \sw[1]~input_o\ $ (((\PB[0]~input_o\) # (\PB[1]~input_o\)))
